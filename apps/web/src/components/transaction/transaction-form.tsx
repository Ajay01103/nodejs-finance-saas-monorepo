...
const TransactionForm = (props: {
  ...
  return (
    <div className="relative px-2.5 pt-5 pb-10">
      <Form {...form}>
        <form
                ...
                <FormItem className="space-y-1">
                  ...
                  <RadioGroup
                    ...
                    <label
                      ...
                      className={cn(
                        "flex flex-1 cursor-pointer items-center justify-center space-x-2 rounded-md border p-2 font-normal text-sm leading-none shadow-sm",
